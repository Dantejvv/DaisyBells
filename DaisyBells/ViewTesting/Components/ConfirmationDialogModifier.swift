...
private struct ConfirmationDialogPreview: View {
    @State private var dialogConfig: ConfirmationDialogConfig?
    @State private var message = "No action taken"
        ...
        VStack(spacing: 20) {
            ...
            Button("Delete Exercise", role: .destructive) {
                dialogConfig = ConfirmationDialogConfig(
                    ...
                    message: "This action cannot be undone. All history for this exercise will be preserved.",
                    confirmTitle: "Delete",
